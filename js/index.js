$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    bar1.style.width = 0;
    var sct = $(document).scrollTop();
    if (sct > 1800 && scene02 == true) {
      scene02 = false;
      const barAnimation = setInterval(() => {
        bar1.style.width = t1 + "%";
        t1++ >= gage1 && clearInterval(barAnimation);
      }, 10);
    } else if (sct < 3000 && scene02 == false) {
      scene02 = true;
      const barAnimation = setInterval(() => {
    ...
    bar2.style.width = 0;
    var sct = $(document).scrollTop();
    if (sct > 1800 && scene03 == true) {
      scene03 = false;
      const barAnimation = setInterval(() => {
        bar2.style.width = t2 + "%";
        t2++ >= gage2 && clearInterval(barAnimation);
      }, 10);
    } else if (sct < 3000 && scene03 == false) {
      scene03 = true;
      const barAnimation = setInterval(() => {
    ...
    bar3.style.width = 0;
    var sct = $(document).scrollTop();
    if (sct > 1800 && scene04 == true) {
      scene04 = false;
      const barAnimation = setInterval(() => {
        bar3.style.width = t3 + "%";
        t3++ >= gage3 && clearInterval(barAnimation);
      }, 10);
    } else if (sct < 3000 && scene04 == false) {
      scene04 = true;
      const barAnimation = setInterval(() => {
    ...
    bar4.style.width = 0;
    var sct = $(document).scrollTop();
    if (sct > 1800 && scene05 == true) {
      scene05 = false;
      const barAnimation = setInterval(() => {
        bar4.style.width = t4 + "%";
        t4++ >= gage4 && clearInterval(barAnimation);
      }, 10);
    } else if (sct < 3000 && scene05 == false) {
      scene05 = true;
      const barAnimation = setInterval(() => {
